    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center surface-elevated rounded-3xl p-12 animate-fadeIn">
          ...
          <p className="mt-4 text-ink-2 font-medium">Cargando promociones...</p>
        </div>
      </div>
    )
  }
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {promotions.length === 0 && (
          <div className="surface rounded-3xl shadow-sm p-12 text-center">
            ...
            <h3 className="text-xl font-bold text-ink mb-2">No hay promociones disponibles</h3>
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {activePromotions.map((promo) => (
                <div key={promo.id} className="surface rounded-3xl shadow-sm border-green-200 overflow-hidden hover:shadow-md transition-all group">
                  {/* Imagen */}
                  {promo.image_url && (
                  ...
                  {/* Contenido */}
                  <div className="p-6">
                    <h3 className="text-xl font-bold text-ink mb-2">{promo.name}</h3>
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {upcomingPromotions.map((promo) => (
                <div key={promo.id} className="surface rounded-3xl shadow-sm border-blue-200 overflow-hidden opacity-75">
                  {promo.image_url && (
                    <div className="relative h-48 overflow-hidden">
                      <Image
                        src={promo.image_url}
                  ...
                  <div className="p-6">
                    <h3 className="text-xl font-bold text-ink mb-2">{promo.name}</h3>
                    {promo.price && (
                      <p className="text-3xl font-bold text-ink-2 mb-3">
                        ${promo.price.toFixed(2)}
                      </p>
                    )}
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {expiredPromotions.map((promo) => (
                <div key={promo.id} className="surface rounded-3xl shadow-sm border-black/10 overflow-hidden opacity-50">
                  {promo.image_url && (
                    <div className="relative h-48 overflow-hidden">
                      <Image
                        src={promo.image_url}
