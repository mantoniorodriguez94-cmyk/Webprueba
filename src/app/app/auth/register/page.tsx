...
export default function RegisterPage() {
  ...
  const handleGoogleSignup = async () => {
    ...
    try {
      ...
      // No necesitamos hacer nada más, el usuario será redirigido a Google
      // y luego al callback, que redirigirá al dashboard
    } catch (err: any) {
      console.error('Error registrándose con Google:', err);
      ...
      <div className="w-full max-w-md animate-fadeIn">
        ...
        <div className="bg-transparent backdrop-blur-sm rounded-3xl shadow-2xl border-2 border-white/20 p-6 sm:p-8 lg:p-10">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 bg-white text-gray-700 font-semibold py-3 sm:py-4 px-6 rounded-2xl hover:bg-gray-50 hover:shadow-lg active:scale-[0.98] transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none text-sm sm:text-base border-2 border-gray-200"
          >
            {googleLoading ? (
              <>
