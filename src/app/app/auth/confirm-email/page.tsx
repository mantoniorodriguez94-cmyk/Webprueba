...
export default function ConfirmEmailPage() {
  ...
  return (
    <div className="bg-transparent backdrop-blur-sm rounded-3xl shadow-2xl border-2 border-white/20 p-6 sm:p-8 lg:p-10 text-center space-y-4">
      <div className={`flex items-center justify-center gap-3 ${isError ? "text-red-400" : "text-green-400"}`}>
        {isLoading ? (
      ...
      {isError && (
        <div className="space-y-3 pt-2">
          <Link
            href="/app/auth/login"
            className="block w-full bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-2xl py-3 font-semibold hover:shadow-xl transition-all duration-300"
          >
