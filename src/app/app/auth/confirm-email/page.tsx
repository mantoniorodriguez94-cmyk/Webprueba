...
export default function ConfirmEmailPage() {
  ...
  return (
    <div className="surface-elevated rounded-3xl p-6 sm:p-8 lg:p-10 text-center space-y-4">
      ...
      {isError && (
        <div className="space-y-3 pt-2">
          <Link
            href="/app/auth/login"
            className="block w-full bg-blue-500 hover:bg-blue-600 text-white rounded-2xl py-3 font-semibold hover:shadow-xl transition-all duration-300"
          >
