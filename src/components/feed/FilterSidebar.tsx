...
export default function FilterSidebar({ onFilterChange }: FilterSidebarProps) {
  ...
  return (
    <>
      ...
      <div
        className={`
          fixed lg:sticky lg:top-24 left-0 h-[calc(100vh-6rem)] z-50
      ...
      >
        ...
        <div className="mb-6">
          ...
          <div className="relative">
            <input
              ...
              className="w-full px-4 py-3 pr-10 border-2 border-gray-200 rounded-2xl focus:outline-none focus:border-[#0288D1] focus:ring-4 focus:ring-[#E3F2FD] transition-all duration-300 text-gray-900"
            />
            <svg
              ...
              <button
                ...
                className={`
                  ...
                  ${filters.category === cat
                    ? "bg-gradient-to-r from-[#0288D1] to-[#0277BD] text-white shadow-md scale-[1.02]"
        ...
        <button
          ...
          className="w-full border-2 border-gray-300 text-gray-700 hover:bg-gray-50 font-semibold py-3 px-4 rounded-2xl transition-all duration-300 hover:shadow-md"
        >
          Limpiar filtros
        </button>
      </div>
