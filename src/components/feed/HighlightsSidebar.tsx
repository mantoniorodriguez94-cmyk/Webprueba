...
export default function HighlightsSidebar({ 
  ...
  return (
    <div className="hidden xl:block sticky top-24 h-[calc(100vh-6rem)] overflow-y-auto space-y-6">
      {/* Eventos Destacados */}
      <div className="bg-white/90 backdrop-blur-md rounded-3xl shadow-2xl border-2 border-white/40 p-6 animate-fadeIn">
      ...
      {/* Negocios Destacados */}
      <div className="bg-white/90 backdrop-blur-md rounded-3xl shadow-2xl border-2 border-white/40 p-6 animate-fadeIn" style={{ animationDelay: "200ms" }}>
        <h3 className="text-xl font-bold text-gray-900 mb-4 flex items-center gap-2">
          <svg className="w-6 h-6 text-[#0288D1]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {/* Tips y Sugerencias */}
      <div className="bg-gradient-to-br from-[#E3F2FD]/90 to-[#BBDEFB]/90 backdrop-blur-md rounded-3xl shadow-2xl border-2 border-white/40 p-6 animate-fadeIn" style={{ animationDelay: "400ms" }}>
