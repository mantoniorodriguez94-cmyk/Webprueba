...
export default function ReportReviewModal({
  ...
  // Ver nota en ReportBusinessModal: cierre en dos tiempos para que la
  // animación de salida de Dialog se reproduzca antes de que el padre
        ...
        <div className="p-6">
          ...
          {reviewComment && (
            <div className="mb-4 p-3 bg-gray-50 rounded-lg">
              <p className="text-xs text-gray-500 mb-1">Reseña reportada:</p>
              <p className="text-sm text-gray-700 italic">&ldquo;{reviewComment.substring(0, 100)}{reviewComment.length > 100 ? '...' : ''}&rdquo;</p>
            </div>
          )}
